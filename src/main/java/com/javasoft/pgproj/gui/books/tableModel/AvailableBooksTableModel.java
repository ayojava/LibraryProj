 ...
 * @author ayojava
 */
public class AvailableBooksTableModel extends AbstractTableModel {
    ...
    public AvailableBooksTableModel() {
    ...
    public int getRowCount() {
        return ((Long) manager.createNamedQuery("Book.findAvailableBooksCount").getSingleResult()).intValue();
    }
    ...
    private List<Book> getBooks(int from, int to) {
        ...
        Query query = manager.createNamedQuery("Book.findAvailableBooks").setMaxResults(to - from).setFirstResult(from);
